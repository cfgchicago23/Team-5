  ...
  <main>
     ...
     <Navbar page="resources"/>
      <div className="resourcesContainer"> 
       ...
       <div className="leftSquare"><h3 className="title">Windows 101:</h3><p className="textInsideSquare">For those, who will be taking part of working with window installation for the rebuilding process:</p>
       ...
       <div className="rightSquare"><h3 className="title">Drywall and Plaster 101:</h3><p className="textInsideSquare">For those, who will be taking part of working with the drywall and plasterwork for the rebuilding process:</p>
       ...
       <div className="leftSquare"><h3 className="title">Flooring Installation 101:</h3><p className="textInsideSquare">For those, who will be taking part of working with the flooring and installation process:</p>
       ...
       <div className="rightSquare"><h3 className="title">HVAC 101:</h3><p className="textInsideSquare">For those, who will be taking part of the HVAC process here are the basics:</p>
       ...
       <div className="leftSquare"><h3 className="title">Plumbing 101:</h3><p className="textInsideSquare">For those, who will be taking part of the plumbing process here are the basics:</p>
       ...
       <div className="rightSquare"><h3 className="title">Electricity 101:</h3><p className="textInsideSquare">For those, who will be taking part of the electricity process here are the basics:</p>
       ...
       <div className="leftSquare"><h3 className="title">Landscaping 101:</h3><p className="textInsideSquare">For those, who will be taking part of the landscaping process here are the basics:</p>
