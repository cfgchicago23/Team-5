  ...
  <main>
    ...
    <div className = "bodyResource">
     <div className="resourcesContainer"> 
       ...
       <div className="rightSquare"><h3 className="title">Drywall and Plasterwork 101:</h3><p className="textInsideSquare">For those, who will be taking part of working with the drywall and plasterwork for the rebuilding process:</p>
